...
class PoseStorageNode:
    def __init__(self):
        ...
        self.set_table_sub = rospy.Subscriber('/set_table', Int32, self.set_table_callback)
    ...
    def set_table_callback(self, data):
        ...
        if table_number > 0:
            ...
            elif table_number == 99:
                table_location = 'make_location'
            else:
                table_location = "table"+str(table_number)+"_location"
    ...
    def save_to_yaml(self, filename, data):
        ...
        rospack = RosPack()
        package_path = rospack.get_path("rto_navigation")  # Replace "rto_navigation" with your ROS package name
